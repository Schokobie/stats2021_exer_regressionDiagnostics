...
packages <- c("tidyverse","rio","jmv","boot","car","QuantPsyc","lmtest","faraway","broom", "Rtools")
```
...
\`\`{r eval=FALSE} \#
<a href="https://web.stanford.edu/class/stats191/notebooks/Diagnostics_for_multiple_regression.html" class="uri">https://web.stanford.edu/class/stats191/notebooks/Diagnostics_for_multiple_regression.html</a>
\# If the partial regression relationship is linear, this plot should
look linear. avPlots(model.3, ‘Adverts’) avPlots(model.3, ‘Airplay’)
...
![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-22-1.png)![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-22-2.png)![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-22-3.png)![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-22-4.png)
...
![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-23-1.png)
...
![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-25-1.png)
...
![](Regression-Diagnostics-Assignment_files/figure-markdown_github/unnamed-chunk-27-5.png)
